...
public class HW5 
{
    public static void main(String[] args) 
    {
        ...
        do
        {
            ...
            //validate that the user input is an available option in our menu
            ...
            int insertPosition)
    {
        ...
        //utilize printf to get proper spacing and $
        System.out.println("=========================================");
    ...
    public static String[] splitName(String inputName)
    {
        ...
        //build the first name, skip the space, build the last name
        String[] customerName = {"", ""};
        int placeHolder = 0;
    ...
    {    
        ...
        //if a value is null, that is your next available space
        int position = 0;
    ...
    public static int chooseCustomer(String[][] nameTable)
    {
        ...
        {
            System.out.print("Please enter a valid option between 0 and " 
                    + counter + ": ");
            choice = in.nextInt();
        }
        return choice;
            ...
            int insertPosition)
    {
        ...
        Scanner in = new Scanner(System.in);
        //let's do data validation so that you can't input any number
        //below 0
